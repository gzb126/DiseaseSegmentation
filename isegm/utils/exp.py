...
def init_experiment(args, model_name):
    ...
    if ftree is None:
        print('Models can only be located in the "models_v1.0.0" directory in the root of the repository')
        sys.exit(1)
...
def get_model_family_tree(model_path, terminate_name='models_v1.0.0', model_name=None):
